...
<div class="well" style=" background: rgb(250, 250, 250);">
    ...
    <div class="custom" style="font-size: 25px;color: #2e3436;">
        <img src="{{ asset('images/500.png') }}" alt="Plex" title="No copyright infringement intended, Please contact developer via Contact Page if removal of this image is required.">
        <br><br>
